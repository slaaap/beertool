...
import uk.beertool.recipe.DEFAULT_COOLING_TIME_MIN
...
import uk.beertool.recipe.DEFAULT_WHIRLPOOL_TEMP_C
...
data class BrewerPreferences(
    ...
    val whirlpoolTempC: Double = DEFAULT_WHIRLPOOL_TEMP_C,
    val coolingTimeMin: Int = DEFAULT_COOLING_TIME_MIN,
    ...
    val whirlpool: Whirlpool get() = Whirlpool(whirlpoolTempC, coolingTimeMin)
}
